...
mongoose.connect(
  "mongodb+srv://aryaayush0208_db_user:XxRj4LheObjx2X9F@cluster0.marp0qm.mongodb.net/?appName=Cluster0",
...
app.use(helmet());
app.use(cors({
  origin: ["https://up-event.vercel.app", "http://localhost:3000"],
...
app.listen(8800, () => {
  console.log("REST API server running on port 8800");
});
